    ...
    public static partial class Methods
    {
        ...
        public static void DisplayReportResult(Activity activityContext, dynamic respond)
        {
            if (Settings.SetApisReportMode)
            {
                ...
                {
                    errorText = errorMessage._errors.ErrorText;
                    ...
                    if (chkintent != null)
                    {
                        if (userId != "")
                        {
                            ...
                            if (launchIntent != null)
                            {
                                ...
                                if (userChat != null)
                                {
                                    var time = Time.TimeAgo(int.Parse(userChat.LastseenUnixTime), false);
...
#pragma warning restore 618
            ...
            private static string GetDirectoryDcim()
            {
                try
                {
                    var directories1 = Application.Context.GetExternalFilesDirs(null); //storage/emulated/0/Android/data/com.badami.app/files
