...
namespace WoWonder.Activities.NearBy
{
    public class FilterNearByDialogFragment : BottomSheetDialogFragment, SeekBar.IOnSeekBarChangeListener, MaterialDialog.IListCallback, MaterialDialog.ISingleButtonCallback
    {
        ...
        private TextView IconBack, IconGender, IconDistance, IconOnline, TxtDistanceCount, IconRelationship, TxtRelationship, RelationshipMoreIcon;
        ...
        private void InitComponent(View view)
        {
            try
            {
                ...
                IconRelationship = view.FindViewById<TextView>(Resource.Id.IconRelationship);
        ...
        private void GetFilter()
        {
            try
            {
                ...
                if (data != null)
                {
                    ...
                    //////////////////////////// Gender //////////////////////////////
                    Gender = data.Gender;
                    var check = GenderAdapter.GenderList.FirstOrDefault(a => a.GenderId == data.Gender);
                    if (check != null)
                    {
