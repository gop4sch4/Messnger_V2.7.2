...
namespace WoWonder.Activities.FriendRequest.Adapter
{
    public class FriendRequestsAdapter : RecyclerView.Adapter/*, ListPreloader.IPreloadModelProvider*/
    {
        ...
        public override RecyclerView.ViewHolder OnCreateViewHolder(ViewGroup parent, int viewType)
        {
            try
            {
                ...
                var vh = new FriendRequestsAdapterViewHolder(itemView, Click, LongClick);
                return vh;
            }
            ...
            try
            {
                if (viewHolder is FriendRequestsAdapterViewHolder holder)
                {
                    ...
                    if (item != null)
                    {
                        ...
                        holder.About.Text = ActivityContext.GetString(Resource.String.Lbl_Last_seen) + " " + Methods.Time.TimeAgo(int.Parse(item.LastseenUnixTime), false);
                    }
                }
            }
            catch (Exception exception)
    ...
    {
        public FriendRequestsAdapterViewHolder(View itemView, Action<FriendRequestsAdapterClickEventArgs> clickListener,
