...
namespace WoWonder.Activities.FriendRequest
{
    ...
    public class FriendRequestActivity : AppCompatActivity
    {
        ...
        private void SetRecyclerViewAdapters()
        {
            try
            {
                MAdapter = new FriendRequestsAdapter(this) { UserList = ListUtils.FriendRequestsList };
        ...
        private void UserDialogOnOnUserUpComplete(object sender, DialogFriendRequests.FriendRequestsUpEventArgs onFriendRequestsUpEventArgs)
        {
            try
            {
