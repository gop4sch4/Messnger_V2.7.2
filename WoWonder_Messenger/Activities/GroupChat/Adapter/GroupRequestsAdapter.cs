...
namespace WoWonder.Activities.GroupChat.Adapter
{
    public class GroupRequestsAdapter : RecyclerView.Adapter
    {
        ...
        public ObservableCollection<GetGeneralDataObject.GroupChatRequest> GroupList = new ObservableCollection<GetGeneralDataObject.GroupChatRequest>();
        ...
        public GetGeneralDataObject.GroupChatRequest GetItem(int position)
        {
